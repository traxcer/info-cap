...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { cierre: @curso.cierre, comienzo: @curso.comienzo, final: @curso.final, lugar: @curso.lugar, tipo: @curso.tipo, turno: @curso.turno }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { cierre: @curso.cierre, comienzo: @curso.comienzo, final: @curso.final, lugar: @curso.lugar, tipo: @curso.tipo, turno: @curso.turno }
    assert_redirected_to curso_path(assigns(:curso))
  end
